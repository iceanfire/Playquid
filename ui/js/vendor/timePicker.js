...
;(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var defaults = {
            ...
            //  callback function to be executed when a month is rendered
            //  the callback function takes 3 arguments:
            //  -   the date in the format specified by the "format" attribute;
            //  -   the date in YYYY-MM-DD format
            //  -   the date as a JavaScript Date object
        ...
        var init = function(update) {
            ...
            // if calendar icon exists (there's no icon if the date picker is always visible)
            if (undefined != icon)
		...
		var manage_views = function() {
            ...
            if (plugin.settings.onChange && typeof plugin.settings.onChange == 'function' && undefined != view) {
                ...
                // execute the callback function and send as arguments the current view and the elements in the view
                plugin.settings.onChange(view, elements);
